        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PricePerMonth = table.Column<decimal>(type: "decimal(18,2)", nullable: false, comment: "House monthy price"),
                    CategoryId = table.Column<int>(type: "int", nullable: false, comment: "Category identifier"),
                    AgentId = table.Column<int>(type: "int", nullable: false, comment: "Agent identifier"),
                    RenterId = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "User renter identifier")
                },
                constraints: table =>
                {
